...
def dpBuff(i):
  return i.buffer(100) #doing a 100m buffer for general use
...
def RefPull457(image):
  ...
  dswe3 = d.eq(3).rename('dswe3').selfMask().updateMask(f.eq(0))
...
for tiles in pr:
  ...
  dataOut = (ee.batch.Export.table.toDrive(collection = out,
                                          ...
                                          'kurt_SurfaceTemp','prop_clouds','prop_hillShadow','pCount_dswe', 'pCount_dswe3','min_cloud_dist', 'mean_cloud_dist','system:index']))
