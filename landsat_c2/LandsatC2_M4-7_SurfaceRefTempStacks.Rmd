...
```{r}
#point to file in your data directory path - this file must contin the parameters Latitude, Longitude, id, and name for this section of code to work correctly
...
def RefPull457(image):
  ...
  .combine(ee.Reducer.count().unweighted().forEachBand(pixOut.select(['Blue', 'Green', 'Red', 'Nir', 'Swir1', 'Swir2','SurfaceTemp', 'dswe1', 'dswe3'])), outputPrefix = 'pCount_', sharedInputs = False)
