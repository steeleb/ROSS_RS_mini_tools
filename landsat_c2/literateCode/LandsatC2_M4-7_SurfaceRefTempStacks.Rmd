...
data_dir = 'path/to/your/lat-lon/location/file/'
```
...
locs = read.csv(file.path(data_dir, 'name_of_you_lat_long_file.csv'))
...
proj_folder = 'drive_folder_to_save_to'
```
