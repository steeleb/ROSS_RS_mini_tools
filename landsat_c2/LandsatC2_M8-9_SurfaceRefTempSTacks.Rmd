...
def RefPull89(image):
  ...
  dswe3 = d.eq(3).rename('dswe3').selfMask().updateMask(f.eq(0)).updateMask(r.eq(0))
...
for tiles in pr:
  ...
  dataOut = (ee.batch.Export.table.toDrive(collection = out,
                                          ...
                                          'kurt_SurfaceTemp', 'prop_clouds','prop_medHighAero','prop_hillShadow','pCount_dswe', 'pCount_dswe3', 'min_cloud_dist', 'mean_cloud_dist','system:index']))
