...
def RefPull89(image):
  ...
  .combine(ee.Reducer.count().unweighted().forEachBand(pixOut.select(['Aerosol','Blue', 'Green', 'Red', 'Nir', 'Swir1', 'Swir2','SurfaceTemp', 'dswe1', 'dswe3'])), outputPrefix = 'pCount_', sharedInputs = False)
