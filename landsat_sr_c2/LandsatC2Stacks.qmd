...
*Updates in this script includes updating to Landsat Collection 2 and including the Landsat 9 mission. Additional feature adds are applying fmask using **SR_Cloud_QA** band for the Level 2 surface reflectance (SR) product and using the **ST_QA** band to mask less-accurate surface temperature (ST) pixels*
