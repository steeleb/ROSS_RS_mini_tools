...
def RefPull(image):
  ...
  pixOut = (image.addBands(hs)
            ...
            .addBands(dummy)
            .addBands(clouds))
  simpleReducer = ee.Reducer.median().unweighted().forEachBand(pixOut.select(['Aerosol','Blue', 'Green', 'Red', 'Nir', 'Swir1', 'Swir2', 'SurfTemp', 'pixel_qa']))
  ...
  lsout = pixOut.select(['Aerosol','Blue', 'Green', 'Red', 'Nir', 'Swir1', 'Swir2', 'SurfTemp', 'pixel_qa']).reduceRegions(lakes, simpleReducer, 30)
